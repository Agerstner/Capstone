      ...
      <div class="container">
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="one">                    
                    <p>
                     ...
                     ${loggedInUser.firstname} ${loggedInUser.lastname}<br>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                     <form:input path="firstname" value="${loggedInUser.firstname}" placeholder="First Name" /> 
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                     <form:input path="lastname" value="${loggedInUser.lastname}" placeholder="Last Name" /> 
                    </div>                    
                  </div>
        ...
        <c:if test="${not empty loggedInUser.image}">
			...
			<c:if test="${not empty loggedInUser.image}">
				...
				<a  href="#" data-toggle="modal" data-target="#add-images" 	class="btn btn-danger">	Add Image</a>
			</c:if>
